...
def unpucking_weather_info(main_weather_info):
    needed_info_from_weather_1 = []
    first_week_weather = []
    ...
    for tmp_info_weather in first_week_weather:
        needed_info_from_weather_1.append(tmp_info_weather.get('temp'))
        needed_info_from_weather_1.append(tmp_info_weather.get('feels_like'))
        needed_info_from_weather_1.append(tmp_info_weather.get('weather'))
        needed_info_from_weather_1.append(tmp_info_weather.get('rain'))
        needed_info_from_weather_2.append(needed_info_from_weather_1)
        needed_info_from_weather_1 = []
    return needed_info_from_weather_2
    '''
